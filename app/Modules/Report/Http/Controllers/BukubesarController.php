...
class BukubesarController extends Controller
{
            ...
            public function __construct()
            {
                ...
                $this->middleware(['permission:report-bukubesar-view']);

                $this->_data['string_menuname']             = 'Buku Besar';
            }
            ...
            public function index(){
                ...
                return Theme::view('modules.report.bukubesar.show',$this->_data);
            }
            ...
            public function retrieve($get){
                ...
                if($Action == 'excel'){
                    ...
                    Excel::create('Bukubesar'.DateFormat($From,'dmy')."_".DateFormat($To,"dmy"), function($excel) use($Info,$data) {

                        $excel->sheet('Report Buku Besar', function($sheet) use($Info,$data) {
                    ...
                    $pdf = PDF::loadView('pdf.bukubesar', $data);
                    return $pdf->download('bukubesar'.date('dmYHis').'.pdf');
                }
